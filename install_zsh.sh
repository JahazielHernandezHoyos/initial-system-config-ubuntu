...
# CASE_SENSITIVE="true"
-rw-r--r--  1 anthony anthony  50K Aug 18 15:29 .zcompdump-anthony-5.8.1
# Uncomment the following line to use hyphen-insensitive completion..8.1.zwc
# Case-sensitive completion must be off. _ and - will be interchangeable.
# HYPHEN_INSENSITIVE="true"ny 4.0K Aug 18 15:24 .zshrc
drwx------  3 anthony anthony 4.0K Aug 18 12:16 snap
